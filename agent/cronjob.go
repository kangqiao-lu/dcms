...
type CronJob struct {
	...
	expression *cronexpr.Expression // expression generated by Schedule
	Dcms       *Agent               // Dcms this CronJob belong to

	SuccessCnt    int    `json:"success_cnt"`     // success count
	ErrCnt        int    `json:"error_cnt"`       // failed count
	TimeoutCnt    int    `json:"timeout_cnt"`     // timeout count (update success or failed count)
